...
#pragma region Model Positioning
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::X))
	{
		...
		{		
			...
			m_mOrientation *= glm::rotate(IDENTITY_M4, 1.0f, REAXISX);
		}
		else
		{
			m_v3Rotation += vector3(-1.0f, 0.0f, 0.0f);
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
	{
		if (!bModifier)
		{
			...
			m_mOrientation *= glm::rotate(IDENTITY_M4, 1.0f, REAXISY);
		}
		else
		{
			m_v3Rotation += vector3(0.0f, -1.0f, 0.0f);
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
	{
		if (!bModifier)
		{
			...
			m_mOrientation *= glm::rotate(IDENTITY_M4, 1.0f, REAXISZ);
		}
		else
		{
			m_v3Rotation += vector3(0.0f, 0.0f, -1.0f);
